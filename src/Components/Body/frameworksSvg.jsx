        ...
        <section className="py-5 border-top border-bottom bg-light" style={{marginTop: '30px'}}>
            <div className="container py-4">
                <div className="row">
                    ...
                    <div className="col-lg-2 col-md-4 col-6"><img src="https://cdn.worldvectorlogo.com/logos/next-js.svg" alt="something" data-toggle="tooltip" data-placement="bottom" title="Customer 5" className="customer img-fluid d-block mx-auto m-2 p-4 p-md-0"/></div>
